  ...
  return (
    ...
    >
      ...
      <div className="flex gap-8 mb-6 items-center">
        <img src={fsssLogo} alt="FSSS" className="h-16 object-contain animate-pulse" style={{ animationDuration: '2s' }} />
        <img src={enfLogo} alt="Enfermagem" className="h-16 object-contain animate-pulse" style={{ animationDuration: '2.5s' }} />
      </div>

      {/* Card de Login Estilizado */}
      <Card className="w-full max-w-[320px] bg-slate-900/40 border-white/10 backdrop-blur-xl shadow-[0_0_40px_-10px_rgba(124,58,237,0.5)] z-10 overflow-hidden border-t-white/20">
        ...
        <CardContent className="pt-4">
          ...
          <form onSubmit={handleAuth} className="space-y-3">
            ...
            <Button 
              type="submit" 
              disabled={loading} 
              className="w-full bg-violet-600 hover:bg-violet-500 text-white h-10 font-black text-sm shadow-lg shadow-violet-900/40 transition-all active:scale-95"
            >
